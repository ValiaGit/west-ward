...
CREATE TABLE `core_logs` (
  ...
  `logType` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1 Info\n2 Warn\n3 Error\n4 Alert\n5 Protection was modified',
  `logParams` varchar(255) NOT NULL,
  PRIMARY KEY (`id`,`core_users_id`),
  KEY `fk_core_logs_core_users1_idx` (`core_users_id`),
  CONSTRAINT `fk_core_logs_core_users1` FOREIGN KEY (`core_users_id`) REFERENCES `core_users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
