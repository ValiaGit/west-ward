...
INSERT INTO `core_security_questions` VALUES (1,'Father\'s first name?'),(2,'Mother\'s first name?'),(3,'First School?'),(4,'What is your pet’s name?'),(5,'Mother\'s maiden name?'),(6,'In what year was your father born?');
