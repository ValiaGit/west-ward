...
CREATE TABLE `core_otp` (
  ...
  `otp_value` varchar(45) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`,`core_users_id`),
  KEY `fk_core_otp_core_users1_idx` (`core_users_id`),
  CONSTRAINT `fk_core_otp_core_users1` FOREIGN KEY (`core_users_id`) REFERENCES `core_users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
