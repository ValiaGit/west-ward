App.view('affiliation',{
    ...
    init: function(transaction_id,users_id) {
        ...
        var me = this,
            ...
            container = new Tab({
                id: 'gametrans',
                name: "Becoming Affiliate Payments"
            });
        ...
        var grid = me.createGrid('AffiliateTransactionsGrid',container);

        $('.col-sm-1').removeClass('active');
        $('.col-sm-1[data-controller=affiliation]').addClass("active");
        ...
        grid.kendoGrid({
            ...
            dataSource: {
                transport: {
                    ...
                    //},
                    read: {
                        url: API.getUrl('financial.affiliatetransactions','getTransactionsList'),
                        dataType: 'json',
                        type: 'POST'
                    }
                },
