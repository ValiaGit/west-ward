        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default panel-profile no-space">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <input type="submit" class="btn btn-28 btn-space btn-dark-blue"
                                                   id="SubmitTransactionsSearch" value="Search">
                                        </div>
                                    </div>
                                    <!-- row -->
                    ...
                    <table class="table table-custom" id="transactionsHistory">
                        <thead>
                        <tr>
                            <th>{{$lang_arr.date}}</th>
                            <th>{{$lang_arr.account}}</th>
                            <th>{{$lang_arr.provider}}</th>
                            <th>{{$lang_arr.amount}} (&#8364;)</th>
                            <th>{{$lang_arr.commission}} (&#8364;)</th>
                            <!--<th>{{$lang_arr.cut_amount}} ($)</th>-->
